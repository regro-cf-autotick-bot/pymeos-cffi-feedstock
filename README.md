...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pymeos-cffi-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pymeos-cffi-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add pymeos-cffi
# for installing globally
pixi global install pymeos-cffi
```
...
It is possible to list all of the versions of `pymeos-cffi` available on your platform:
...
```
pixi search pymeos-cffi --channel conda-forge
```
